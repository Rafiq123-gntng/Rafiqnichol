...
<head>
    ...
    <link rel="icon" href="../assets/img/picture.png" type="" />
        ...
        <div class="main-header">
            ...
            <div class="logo-header" data-background-color="purple">
                ...
                <a href="index.html" class="logo">
                    <img src="../assets/img/ELRAFIQLG1.png" width="69" alt="navbar brand" class="navbar-brand">
                </a>
                        ...
                        <li class="nav-item dropdown hidden-caret">
                            ...
                            <ul class="dropdown-menu dropdown-user animated fadeIn">
                                <div class="dropdown-user-scroll scrollbar-outer">
                                    <li>
                                        <div class="user-box">
                                            <div class="avatar-lg"><img src="../assets/img/Zee.jpg" alt="image profile" class="avatar-img rounded"></div>
                                            <div class="u-text">
